...
namespace PicoLed
{
    ...
    WS2812B::WS2812B(PIO pioBlock, uint stateMachine, uint dataPin, uint numLeds, DataByte b1, DataByte b2, DataByte b3, DataByte b4, bool isInverted) : PioStrip(pioBlock, stateMachine, dataPin, numLeds, b1, b2, b3, b4, isInverted)
    {
