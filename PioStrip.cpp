...
namespace PicoLed
{
    ...
    PioStrip::PioStrip(
        PIO pioBlock, uint stateMachine, uint dataPin, uint numLeds, DataByte b1, DataByte b2, DataByte b3, DataByte b4, bool isInverted) : PicoLedTarget(numLeds, b1, b2, b3, b4), pioBlock(pioBlock), stateMachine(stateMachine), dataPin(dataPin)
    {
